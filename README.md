...
| [`examples/custom-agents/`](examples/custom-agents/) | Inject custom AI agents via `ConfigUpdate` (GET-merge-PATCH), then reference one by name in a session. | `go run examples/custom-agents/main.go` |
